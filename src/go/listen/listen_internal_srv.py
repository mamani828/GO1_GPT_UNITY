#!/usr/bin/env python3
""" Starts the internal Listen service. The service can be forked by the main script however it will overcrowd the terminal potentially causing it to crash. """
